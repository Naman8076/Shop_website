...
const Orders = () => {
  ...
  console.log("OrdersStatusChange", OrdersStatusChange);
                    ...
                    ? OrdersData.map((element, index) => {
                        return (
                          <>
                            <tr>
                              <td>{index + 1}</td>
                              <td>{element?.Admin?.totalPrice}</td>
                              ...
                              <td>
                                {element.orderstatus == "Processing" ? (
                                  <Dropdown>
                                    ...
                                    <Dropdown.Menu>
                                      <Dropdown.Item
                                        onClick={() => handleOrderChange("Confirmed",element._id)}
                                      >
                                        Confirm
                                      </Dropdown.Item>
                                    </Dropdown.Menu>
                                  ...
                                  <Dropdown>
                                    ...
                                    <Dropdown.Menu>
                                      <Dropdown.Item 
                                       onClick={() => handleOrderChange("Delivered",element._id)}
