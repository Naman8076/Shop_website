...
//               <Select options={state} onChange={(e)=>setFinalState(e.label)}  placeholder="set your states" />
//             </div>
//             <div className="form_input">
//               <input
//                 type="text"
...
//               onChange={handleChange}
//             >
//               <Form.Control as="textarea" name="description" placeholder="Shipping Address" rows={2} />
//             </Form.Group>
